...
# AUTHOR: Dan Nguyen
# FILENAME: svm.py
# SPECIFICATION: SVM classification of data.
...
for c_item in c:
    for d in degree:
        for k in kernel:
            for s in decision_function_shape:
                ...
                clf = svm.SCV(c = c_item, degree = d, kernal = k, decision_function_shape = s)
                ...
                cur_acc = correct / len(X_test)
                if highest_accuracy < cur_acc:
